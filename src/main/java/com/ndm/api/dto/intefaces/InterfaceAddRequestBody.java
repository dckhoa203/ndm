...
public class InterfaceAddRequestBody {
    ...
    private static final String NETMASK_INVALID_MESSAGE = "Netmask must be in the correct format 000.000.000.000";
    private static final String GATEWAY_INVALID_MESSAGE = "Gateway must be in the correct format 000.000.000.000";
